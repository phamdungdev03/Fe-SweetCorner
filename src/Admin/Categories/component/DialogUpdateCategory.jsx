...
import { apiUpdateCategory } from "../../../Services/Categories";
const DialogUpdateCategory = (props) => {
  const { handleCloseDialog, handleReloadData, selectedCategory } = props;
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await apiUpdateCategory(selectedCategory?.category_id, formData);
      dispatch(
        showToast({
  ...
  useEffect(() => {
    ...
    setValue("category_image", selectedCategory?.category_image);
    const image = formatImg(selectedCategory?.category_image);
