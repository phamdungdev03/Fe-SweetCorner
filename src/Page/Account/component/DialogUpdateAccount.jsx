...
const DialogUpdateUser = ({ accountLogin, handleCloseDialog, ReloadData }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await apiUpdateAccount(accountLogin.account_id, formData);
      ReloadData();
      handleCloseDialog();
      dispatch(
        showToast({
  ...
  useEffect(() => {
    const fetchAccount = async () => {
      try {
        const res = await apiGetAccountById(accountLogin.account_id);
